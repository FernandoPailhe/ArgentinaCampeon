...
object AnalyticsEvents {
    ...
    const val VERSUS_SHARE_IMAGE = "versus_share_image"
    const val TOP_SHARE_IMAGE = "top_share_image"
    const val FAV_SHARE_IMAGE = "fav_share_image"
    const val DET_SHARE_IMAGE = "detail_share_image"
