package com.ferpa.argentinacampeon.worker
...
class DownloadWorker(
    ...
    private val argentinaCampeonService: ArgentinaCampeonService
): CoroutineWorker(context, workerParams) {

    override suspend fun doWork(): Result {
        delay(5000L)
        val response = argentinaCampeonService.downloadImage("")
